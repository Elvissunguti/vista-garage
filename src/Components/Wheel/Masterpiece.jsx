...
import master from "../../Assets/Wheels/Masterpiece/master.webp";
import { masterImg } from "./WheelsData";

const Masterpiece = () => {
    return(
        <section>
            <div className=" flex flex-col flex-col-reverse lg:flex-row bg-black text-white xl:h-[450px]">
                <div className="mt-10  lg:w-1/2 pl-10 ">
                    <h2 className="font-bold text-4xl">
                        Vista "Masterpiece" Wheels 
                    </h2>
