    ...
    return(
        <section>
            ...
            <div className="px-2 mt-10 mx-auto max-w-5xl xl:max-w-7xl xl:px-0">
                <h2 className="font-bold text-2xl xl:text-4xl my-10 text-center title">ENGINE DIAGNOSTICS</h2>
                <div className="lg:w-1/2">
                    <img  src={engine_diagnostics} alt=""
                    className="w-full h-full object-cover" />
                </div>
                <div className="mt-4">
                    <h2 className="font-bold text-2xl xl:text-3xl my-6">
                        SERVICE OVERVIEW
                    </h2>
                    <p className="text-lg">
                        Vista Garage provides full service engine repair, maintenance and even engine replacements if necessary. We can properly assess and repair any problem with your engine, efficiently and honestly. We’ve been doing it since 1999!
                        <br></br>
                        <br></br>
                        Our team of master auto technicians excel in diagnostics and are able to pinpoint and repair problems accurately and in a timely manner. We provide service for all makes and models, foreign and domestic, automatic and manual. Let us help take the stress out of engine service. Call Vista Garage today. 
                    </p>
                </div>
